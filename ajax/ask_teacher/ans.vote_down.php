...
$sql = "SELECT * FROM `answer_like` WHERE question_id='$id' AND user='$user'";
$m  = mysqli_query($db,$sql);
$n = mysqli_num_rows($m);
if ($n==0) {
$sql = "INSERT INTO `answer_like` (`id`, `user`, `question_id`, `vote`, `datetime`) VALUES (NULL, '$user', '$id', '-1', '$date')";
mysqli_query($db,$sql);
