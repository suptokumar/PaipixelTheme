...
?>
<link rel="stylesheet" href="<?php get_domain("/"); ?>css/profile.css?v=45">
...
<input type="search" onkeyup="team_table(this.value,document.getElementsByName('filter_team')[0].value,1)" id="search_user_input" name="search_team" placeholder="Search Team" style="max-width: 160px; float: left; padding: 10px 40px;">
...
<link rel="stylesheet" href="../css/table.css?vp=46">
<?php 
...
while ($row = mysqli_fetch_array($q)) {
	...
	<tr>
		<td><a style="color: blue; font-weight: bold; text-decoration: none;" href="http://localhost/profile/<?php echo $row['user_name'] ?>"<?php $son = $row['user_name'] ?>><?php echo my_name($row['user_name']); ?></a>
<br>
<?php 
